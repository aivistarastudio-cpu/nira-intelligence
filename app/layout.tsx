    ...
    >
      ...
      >
        ...
        <div id="nira-native-preloader" suppressHydrationWarning={true} style={{
          ...
          <svg width="48" height="48" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ animation: "spin 20s linear infinite", color: "#ffffff", opacity: 0.95 }}>
