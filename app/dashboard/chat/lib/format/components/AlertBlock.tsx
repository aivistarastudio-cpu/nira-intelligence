...
export const AlertBlock = React.memo(function AlertBlock({ block }: { block: any }) {
  const getAlertConfig = (type: string) => {
    switch (type) {
      ...
      case "tip": return { bg: "bg-indigo-500/[0.05] dark:bg-indigo-500/[0.02]", border: "border-indigo-500/30", accent: "bg-indigo-500/20 border-indigo-500/40 text-indigo-600 dark:text-indigo-300", emoji: "💡" };
      case "info": return { bg: "bg-[var(--nira-surface)]", border: "border-[var(--nira-border)]", accent: "bg-[var(--nira-text)]/[0.04] border-[var(--nira-border)] text-[var(--nira-text)]", emoji: "ℹ️" };
      ...
      default: return { bg: "bg-[var(--nira-surface)]", border: "border-[var(--nira-border)]", accent: "bg-[var(--nira-text)]/[0.04] border-[var(--nira-border)] text-[var(--nira-text)]", emoji: "ℹ️" };
    }
  };

  const config = getAlertConfig(block.type);
